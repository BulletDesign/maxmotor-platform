...
test("awards one hundred Traction Points for every thirty dollars", () => {
  assert.equal(pointsForPurchase(2999), 0);
  assert.equal(pointsForPurchase(3000), 100);
  assert.equal(pointsForPurchase(32999), 1000);
  assert.equal(pointsForPurchase(33000), 1100);
});
