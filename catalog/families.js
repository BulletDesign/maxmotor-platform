  ...
  window.MAXMOTOR_FAMILIES = [
    {
      ...
      products: [
        { slug: "tapa-trifold", name: "Tapa Trifold", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/tapa_de_balde_3_partes.webp", summary: "Apertura en tres paneles para uso diario y acceso rapido al balde.", features: ["Apertura plegable", "Perfil aerodinamico", "Compatibilidad por modelo"] },
        ...
        { slug: "tapa-enrollable", name: "Tapa de Balde Corrediza", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/Tapa_corrediza_isuzu.webp", summary: "Apertura gradual y cubierta compacta para conservar acceso flexible al balde.", features: ["Apertura regulable", "Diseno compacto", "Uso multiproposito"] },
      ],
    },
    {
    ...
    },
    {
      ...
      products: [
        ...
        { slug: "accesorios-suspension", name: "Accesorios de Suspension", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/suspension_dobinson_instalada.webp", summary: "Espaciadores y componentes complementarios para la puesta a punto.", features: ["Opciones por vehiculo", "Ajuste tecnico", "Instalacion especializada"], photoCredit: "Proyecto real Maxmotor 4x4" },
      ],
    },
    {
      ...
      products: [
        { slug: "tiro-estandar", name: "Barra de Tiro", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/bola_de_tiro_barra_de_tiro.webp", summary: "Receptor fabricado para remolque, portabicicletas y sistemas de carga posteriores.", features: ["Receptor de 2 pulgadas", "Fabricacion MXR", "Aplicacion por vehiculo"], staticPage: "fichas/tiro-estandar.html", photoCredit: "Proyecto real Maxmotor 4x4" },
        { slug: "tiro-hd", name: "Barra de Tiro Heavy Duty", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/barra_de_tiro_tank_500.webp", summary: "Estructura reforzada para aplicaciones de mayor exigencia.", features: ["Construccion reforzada", "Aplicacion de alta carga", "Fabricacion a medida"], staticPage: "fichas/tiro-hd.html", photoCredit: "Proyecto real Maxmotor 4x4" },
    ...
    },
    {
      ...
      products: [
        ...
        { slug: "portabicicletas", name: "Portabicicletas", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/portabicicleta.webp", summary: "Transporte seguro para bicicletas con capacidades y marcas seleccionables.", features: ["Varias capacidades", "Opciones de marca", "Montaje posterior o techo"], photoCredit: "Proyecto real Maxmotor 4x4" },
        { slug: "parrillas-carga", name: "Parrillas de Carga", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/parrilla_de_carga_furgoneta.webp", summary: "Parrillas de aluminio o acero configuradas por carga y vehiculo.", features: ["Aluminio o acero", "Tamanos disponibles", "Carga liviana o pesada"], photoCredit: "Proyecto real Maxmotor 4x4" },
        ...
        { slug: "bed-rack", name: "Bed Rack", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/Parrilla_de_techo_overland.webp", summary: "Estructura modular sobre el balde para organizar equipo overland.", features: ["Complementos modulares", "Fabricacion robusta", "Configuracion por uso"], photoCredit: "Proyecto real Maxmotor 4x4" },
    ...
    },
    {
      ...
      products: [
        { slug: "rollbar-zr", name: "Rollbar ZR", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/rollbar_deportivo_toyota_hilux.webp", summary: "Rollbar de linea angular fabricado para integrar presencia, carga e iluminacion.", features: ["Diseno angular ZR", "Fabricacion nacional", "Aplicacion por camioneta"], photoCredit: "Proyecto real Maxmotor 4x4" },
        ...
        { slug: "rollbar-rr1", name: "Rollbar RR1", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/rollbar_trabajo_jac_t8.webp", summary: "Doble viga angular con configuracion overland.", features: ["Parrilla superior", "Perfil bajo", "Fabricacion nacional"], staticPage: "fichas/rollbar-rr1.html", photoCredit: "Proyecto real Maxmotor 4x4" },
    ...
    },
    {
      ...
      products: [
        { slug: "bullbar-overland", name: "Bullbar Overland", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/Bummper_poer_overland.webp", summary: "Guardachoques frontal de acero con preparacion para wincha y recuperacion.", features: ["Proteccion frontal", "Base para wincha", "Anclaje segun vehiculo"], staticPage: "fichas/bullbar-overland.html", photoCredit: "Proyecto real Maxmotor 4x4" },
        { slug: "bullbar-raptor", name: "Bullbar Raptor", image: "https://media.maxmotor4x4.com/repoimg/bucket_accesorios_autos/bullbar_delantero_poer.webp", summary: "Bullbar de perfil agresivo para proyectos off-road y mayor angulo de ataque.", features: ["Perfil off-road", "Integracion de iluminacion", "Aplicacion por vehiculo"], staticPage: "fichas/bullbar-raptor.html", photoCredit: "Proyecto real Maxmotor 4x4" },
      ],
    },
  ];
})();
