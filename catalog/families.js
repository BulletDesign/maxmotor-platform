(function () {
  ...
  window.MAXMOTOR_FAMILIES = [
    ...
    },
    {
      ...
      products: [
        { slug: "rollbar-hero", name: "Rollbar Hero", image: "https://images.pexels.com/photos/9331954/pexels-photo-9331954.jpeg?auto=compress&cs=tinysrgb&w=1600", summary: "Estructura tubular premium con base portafocos.", features: ["Acero de alta resistencia", "Acabados MXR", "Aplicacion por camioneta"], staticPage: "productos/rollbar-hero.html", photoCredit: "Foto contextual: Rhys Abel / Pexels" },
        { slug: "rollbar-rr1", name: "Rollbar RR1", image: "https://images.pexels.com/photos/13644357/pexels-photo-13644357.jpeg?auto=compress&cs=tinysrgb&w=1600", summary: "Doble viga angular con configuracion overland.", features: ["Parrilla superior", "Perfil bajo", "Fabricacion nacional"], staticPage: "productos/rollbar-rr1.html", photoCredit: "Foto contextual: Scott Neil / Pexels" },
        { slug: "rollbar-hummer", name: "Rollbar Hummer", image: "https://images.pexels.com/photos/28639327/pexels-photo-28639327.jpeg?auto=compress&cs=tinysrgb&w=1600", summary: "Formato tipo jaula con presencia extrema.", features: ["Tubos reforzados", "Acabado texturizado", "Fabricacion a medida"], staticPage: "productos/rollbar-hummer.html", photoCredit: "Foto contextual: Stephen Leonardi / Pexels" },
    ...
    },
    {
      ...
      products: [
        { slug: "estribos-rock", name: "Rock Sliders MXR", image: "https://images.pexels.com/photos/12138568/pexels-photo-12138568.jpeg?auto=compress&cs=tinysrgb&w=1600", summary: "Proteccion lateral estructural para rutas tecnicas.", features: ["Estructura tubular", "Proteccion de zocalos", "Fabricacion por vehiculo"], staticPage: "productos/estribos-rock.html", photoCredit: "Foto contextual: Ryan Leeper / Pexels" },
    ...
    },
    {
      ...
      products: [
        { slug: "bullbar-overland", name: "Bullbar Overland", image: "https://images.pexels.com/photos/5628354/pexels-photo-5628354.jpeg?auto=compress&cs=tinysrgb&w=1600", summary: "Guardachoques frontal de acero con preparacion para wincha y recuperacion.", features: ["Proteccion frontal", "Base para wincha", "Anclaje segun vehiculo"], staticPage: "productos/bullbar-overland.html", photoCredit: "Foto contextual: Erik Mclean / Pexels" },
        { slug: "bullbar-raptor", name: "Bullbar Raptor", image: "https://images.pexels.com/photos/30139881/pexels-photo-30139881.jpeg?auto=compress&cs=tinysrgb&w=1600", summary: "Bullbar de perfil agresivo para proyectos off-road y mayor angulo de ataque.", features: ["Perfil off-road", "Integracion de iluminacion", "Aplicacion por vehiculo"], staticPage: "productos/bullbar-raptor.html", photoCredit: "Foto contextual: Stephen Leonardi / Pexels" },
      ],
    },
  ];
})();
