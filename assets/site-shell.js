  ...
  const header = `
    <div id="main-header-wrapper">
      ...
      <nav>
        ...
        <a class="portal-entry" href="${rootPrefix}portal.html"><span>Mi Maxmotor</span><b aria-hidden="true">→</b></a>
